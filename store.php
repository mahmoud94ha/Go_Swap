...
<div class="preview w3-row-padding " id="myForm">
  ...
  <form action="" method="get" class="w3-card w3-white w3-padding-32 w3-center" style="max-width:fit-content; margin:auto; margin-top:100px; margin-bottom:20px">
      ...
      <p class="w3-margin-bottom">
        <label class="w3-label w3-#4cc9f0"><?php echo lang("ORDER") ?></label>          
        ...
        <p class="w3-margin-bottom">
            <label class="w3-label w3-#4cc9f0"><?php echo lang('NAME') ?></label>
            <select class="w3-select w3-text-grey" name="catID" >
                ...
                <!-- WILAYA -->        
      <p class="w3-margin-bottom">
        <label class="w3-label w3-#4cc9f0"><?php echo lang('WILAYA') ?></label>          
    ...
    <label class="w3-label w3-#4cc9f0 w3-center">RAM [GB]</label>  
    <div class="w3-row-padding w3-margin-bottom">
    ...
    <label class="w3-label w3-#4cc9f0 w3-center w3-margin-bottom"><?php echo lang('STORAGE')?> [GB]</label>  
    <div class="w3-row-padding">
        ...
        <label class="w3-label w3-#4cc9f0 w3-margin-bottom"><?php echo lang('STATUS') ?></label>  
...
<div id="result" class="w3-row-padding w3-white w3-card-4 " style="min-height: 1000px">
    <h2 class="w3-text-dark-grey w3-white w3-margin-bottom xhide "><b><?php echo lang("ALL-ADS") ?></b>
  ...
  <header class="w3-xlarge w3-center">
    ...
    <div class="w3-section w3-padding-16" id="myBtnContainer">
      ...
      <a href="#result" class="filter-link w3-padding w3-light-grey xhide" data-filter="smartphone" style="font-size:initial; text-decoration:none" ><i class="fa fa-fw fa-mobile" ></i><span class="w3-hide-small"><?php echo lang("SMARTPHONE") ?></span></a>
      <a href="#result" class="filter-link w3-padding w3-light-grey xhide" data-filter="tablet" style="font-size:initial; text-decoration:none" ><i class="fa fa-fw fa-tablet w3-margin-right"></i><span class="w3-hide-small"><?php echo lang("TABLET") ?></span></a>
