...
<?php                                                            }
                ...
                <!-- STATUS -->
        <p class="w3-margin-bottom">
            <label class="w3-label w3-#4cc9f0"><?php echo lang('STATUS')?></label>            
    ...
    <div class="w3-half">
        ...
        <p class="w3-margin-bottom">
            ...
            <select class="w3-select w3-text-grey" name="catID" required>
                ...
                <!-- TYPE -->
        <p class="w3-margin-bottom">
            <label class="w3-label w3-#4cc9f0">Type</label>            
...
<div class="w3-half w3-margin-bottom w3-padding">
         ...
         <p class="w3-#4cc9f0"><strong><?php echo lang("CHARACTERISTICS") . " : "  ?></strong></p>
    ...
    <div class="w3-row-padding">
        <div class="w3-third">
        <p class="w3-margin-bottom">
            <label class="w3-label w3-#4cc9f0">RAM</label>            
        ...
        <div class="w3-third">
        <p class="w3-margin-bottom">
            <label class="w3-label w3-#4cc9f0"><?php echo lang("SCREEN") ?></label>            
        ...
        <div class="w3-third">
        <p class="w3-margin-bottom">
            <label class="w3-label w3-#4cc9f0"><?php echo lang("STORAGE") ?></label>            
        ...
        <label class="w3-label w3-#4cc9f0">Camera</label>
    <div class="w3-row-padding">
        <div class="w3-half">
    ...
    <div class="w3-row">
         <p class="w3-#4cc9f0"><strong>Images :</strong></p>        
    <div class="w3-half">        
