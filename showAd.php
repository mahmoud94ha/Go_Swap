...
<?php                
    ...
    <div class="w3-half w3-border">
        ...
        <p class="xhide">
            <i class="fa fa-fw fa-globe" style="color:#4cc9f0"></i>
            <a href="store.php?wilaya=<?php echo $row["wilaya"] ?>"><strong class="w3-text-dark-grey"><?php echo ": " . $row["wilaya"] ?></strong></a>
        </p>
        <p>
            <i class="fa fa-fw fa-calendar-plus w3-#4cc9f0"></i>
            <strong class="w3-text-dark-grey"><?php echo ": " .  proDate($row["add_date"]) ?></strong>
        </p>
        <p><i class="fa fa-fw fa-flag w3-#4cc9f0"></i><strong class="w3-text-dark-grey"><?php echo ": " .  $row["status"] ?>/5</strong></p>      
        <a href="store.php?catID=<?php echo $row["catID"] . "&name=" . $row["name"] ?>">
            <p><i class="fa fa-fw fa-list-alt w3-#4cc9f0"></i> 
                <strong><?php echo " : " . $row["name"] ?></strong>
            </p>
        </a> 
        <p class="w3-hide-small w3-nowrap xhide"><i class="fa fa-fw fa-tag" style="color:#4cc9f0"></i><strong class="w3-text-dark-grey">
                                <?php
...
<div class="des">
<button id="defaultOpen" class="tablink w3-hover-white w3-teal w3-hover-text-teal w3-hover-shadow" onclick="openPage('Items', this, 'teal')" ><?php echo lang("DESCRIPTION") ?></button>
  ...
  <div class="xhide w3-card w3-padding w3-center" style="min-height:300px">
        <p>
            <strong class="w3-#4cc9f0" style="font-size:small">RAM : </strong>
          ...
          <p class="w3-nowrap">
              <strong class="w3-#4cc9f0" style="font-size:small">CPU : </strong>
          ...
          <p>
              <strong class="w3-#4cc9f0" style="font-size:small"><?php echo lang("SIM-CARD") . " : " ?></strong>
          ...
          <p>
              <strong class="w3-#4cc9f0" style="font-size:small"><?php echo lang("SCREEN") . " : " ?></strong>
          ...
          <p>
              <strong class="w3-#4cc9f0" style="font-size:small"><?php echo lang("FRONT-CAMERA") ?></strong>
          ...
          <p>
              <strong class="w3-#4cc9f0" style="font-size:small"><?php echo lang("REAR-CAMERA") ?></strong>
          ...
          <p>
              <strong class="w3-#4cc9f0" style="font-size:small"><?php echo lang("STORAGE") . " : " ?></strong>
          ...
          <p>
              <strong class="w3-#4cc9f0" style="font-size:small"><?php echo lang("OS") . " : " ?></strong>
        ...
        <div id="Subjects" class="tabcontent w3-white">
          <div class="w3-card w3-container w3-center" style="min-height:300px">
                <h4 class="w3-#4cc9f0 w3-margin-bottom"><strong><?php echo lang("ADDED-BY") ?></strong></h4>
                    ...
                    if(!empty($rows)){
                        ...
                        foreach($rows as $comment){
                            ...
                            echo '<div class="w3-col m10 w3-margin-bottom">
                                    <h4 class="w3-#4cc9f0"><a href="profile.php?userID=' . $comment["userID"] . '">'. $comment["username"] .'</a><span class="w3-opacity w3-medium w3-text-grey">'. " " . proDate($comment["comDate"]) .'</span></h4>
