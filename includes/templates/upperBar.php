...
<div class="w3-container">
  ...
  <a href="main.php" class="w3-bar-item"><img class="w3-hover-shadow w3-padding" src="uploads/site_images/logo.png" style="max-height:55px"></a>
  <script>
...
<?php
        ...
        if($title != "Forum") {
        echo '<div class=" xhide w3-quarter w3-padding">
        ...
        ?>
            ...
            <div class="upper-bar w3-animate-top">
                ...
                <a href="main.php" class="w3-bar-item"><img class="w3-hover-shadow w3-round w3-padding" src="uploads/site_images/logo.png" style="max-height:55px" alt="Acceuil"></a>
