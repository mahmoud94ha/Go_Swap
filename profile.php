...
<?php   $user1 = $info["userID"];
        ...
        ?>
         ...
         <p class="w3-text-dark-grey">
             <i class="fa fa-id-card fa-fw w3-margin-right w3-text-theme w3-#4cc9f0"></i>
             <strong>
             <?php 
         ...
         <p class="w3-text-dark-grey">
             <i class="fa fa-home fa-fw w3-margin-right  w3-#4cc9f0"></i>
             <strong>
             <?php 
         ...
         <p class="w3-text-dark-grey">
             <i class="fa fa-birthday-cake fa-fw w3-margin-right w3-#4cc9f0"></i>
             <strong>
             <?php 
         ...
         <p class="w3-text-dark-grey">
             <i class="fa fa-phone fa-fw w3-margin-right w3-#4cc9f0"></i>
             <strong>
             <?php 
                ...
                <?php                    
                    ...
                    <hr>
                        ...
                        <div class="form-group form-group-lg w3-margin-bottom w3-padding">
                            <label class="w3-label w3-#4cc9f0"><?php echo lang("USERNAME") ?></label>
                            <input type="text" name="username" class="w3-input w3-text-grey " autocomplete="off" value="<?php echo $row['username'] ?>"  required="required">    
                                            ...
                                            <!-- E-mail -->
                        <div class="form-group form-group-lg w3-margin-bottom w3-padding">
                            <label class="w3-label w3-#4cc9f0"><?php echo lang("EMAIL") ?></label>                              
                            <input type="email" name="email" class="w3-input w3-text-grey" value="<?php echo $row['email'] ?>" required="required">
                                            ...
                                            <!-- Full name -->
                        <div class="form-group form-group-lg w3-margin-bottom w3-padding">
                            <label class="w3-label w3-#4cc9f0"><?php echo lang("FULLNAME") ?></label>
                        ...
                        <div class="w3-half w3-padding">
                                                                    ...
                                                                    <!-- Telephone -->
                                <div class="form-group form-group-lg w3-margin-bottom w3-padding">
                            <label class="w3-label w3-#4cc9f0"><?php echo lang("PHONE-NUM") ?></label>
                                    <input type="tel" id="phone" name="telephone" class="w3-input w3-text-grey" value="<?php echo $row['telephone'] ?>" >   
                                                ...
                                                <!-- Birth -->
                                <div class="form-group form-group-lg w3-margin-bottom w3-padding">
                            <label class="w3-label w3-#4cc9f0"><?php echo lang("BIRTH-DATE") ?></label>                                    
                    ...
                    <?php                                                            }
                        ...
                        <p class="form-group form-group-lg w3-margin-bottom w3-padding w3-center">
                            <label class="w3-label w3-#4cc9f0"><?php echo lang("INTERESTS") ?></label>                                 
